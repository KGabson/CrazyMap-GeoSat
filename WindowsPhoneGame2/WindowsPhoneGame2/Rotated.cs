...
{    
    class RotatedRectangle
    {
            ...
            public bool IsPixelCollision(Rectangle recA, Color[] dataA, Rectangle recB, Color[] dataB)
            {
                int top = Math.Max(recA.Top, recB.Top);
                int bot = Math.Min(recA.Bottom, recB.Bottom);
                ...
                for (int y = bot - 1; y >= top; y--)
                {
                    ...
                    {
                        Color colorA = dataA[(x - recA.Left) +
                               (y - recA.Top) *
                               recA.Width];
                        Color colorB = dataB[(x - recB.Left) +
                                             (y - recB.Top) *
                                             recB.Width];
